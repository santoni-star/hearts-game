...
class GameActivity : AppCompatActivity() {
    ...
    private fun getLayoutParamsForPosition(pos: Int): LinearLayout.LayoutParams {
        return when (pos) {
            0 -> LinearLayout.LayoutParams(0, 200, 1f).apply { setMargins(3, 4, 3, 4) }
            1, 3 -> LinearLayout.LayoutParams(130, 180).apply { setMargins(2, 2, 2, 2) }
            else -> LinearLayout.LayoutParams(130, 180).apply { setMargins(2, 2, 2, 2) }
        }
    }
