...
class ParticleSystem(private val view: View) {
    ...
    enum class ParticleType {
        HEART,        // Small red heart floating up
        SPARKLE,      // Golden sparkle
        STAR,         // Star for moon celebration
        MOON,         // Moon icon
        CONFETTI,     // Confetti piece
        QUEEN_SPADES  // Q♠ sparkle
    }
    ...
    /** Add heart burst at position (when heart played) */
    ...
    fun celebrateMoonShoot(winnerX: Float, winnerY: Float, screenWidth: Int, screenHeight: Int) {
        ...
        repeat(30) {
            ...
            val colors = arrayOf(
                ...
                Color.parseColor("#FF6B6B"), // Pink
                Color.parseColor("#4ECDC4"), // Teal
                Color.parseColor("#FF6B35"), // Red-orange
            )
        ...
        // Also spawn from top of screen (confetti rain)
        repeat(50) {
    ...
    /** Trick collection particles (cards flying to winner) */
    ...
    /** Pass cards animation particles */
